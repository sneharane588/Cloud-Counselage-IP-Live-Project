...
# F1 score achieved by Gaussian NB is 0.88
...
# F1 score achieved by Logistic Regression is 0.75
...
SVM = svm.SVC(kernel='rbf',C=100,gamma=0.1)
...
# F1 score achieved by SVM is 0.9
...
# F1 score achieved by Neural network and MLP classifier kernel is 0.75
...
# F1 score achieved by KNN kernel is 0.8

# ### _SVM with Poly kernal with degree 8_

# In[32]:


from sklearn.svm import SVC
svclassifier = SVC(kernel='poly', degree=18)
...
# F1 score achieved by SVM with Polynomial kernel is 0.74
